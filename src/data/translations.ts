...
export const translations: Record<Language, Translations> = {
  es: {
    ...
    contact: {
      ...
      note: "El formulario no envía aún; usá el mailto para escribirme directamente.",
      directHeading: "También podés contactarme",
      emailLabel: "Correo directo: juan.cruz@example.com",
  ...
  en: {
    ...
    contact: {
      ...
      note: "The form doesn't send yet; use the mailto link to write me directly.",
      directHeading: "You can also reach me here",
      emailLabel: "Direct email: juan.cruz@example.com",
      mailtoCta: "Open mail client",
      helper:
